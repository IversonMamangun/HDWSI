  ...
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <main class="pt-24 flex-grow w-full max-w-7xl mx-auto px-4 pb-16">
      <div class="mb-10 text-center md:text-left">
        <h1 class="text-[#289F7F] text-3xl md:text-4xl lg:text-5xl font-black mb-2">School of Human-Centered Innovation</h1>
        <h2 class="text-[#2095E0] text-2xl md:text-3xl font-extrabold mb-4">Innovation Designed Around People</h2>
